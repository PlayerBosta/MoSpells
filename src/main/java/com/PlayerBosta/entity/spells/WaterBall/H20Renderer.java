package com.PlayerBosta.entity.spells.WaterBall;
...
public class H20Renderer extends EntityRenderer<FireBomb> {

    private static ResourceLocation TEXTURE = MoreSpells.id("textures/entity/waterball/magma.png");
    private static ResourceLocation SWIRL_TEXTURES[] = {
            IronsSpellbooks.id("textures/entity/waterball/swirl_0.png"),
            IronsSpellbooks.id("textures/entity/waterball/swirl_1.png"),
            IronsSpellbooks.id("textures/entity/waterball/swirl_2.png"),
            IronsSpellbooks.id("textures/entity/waterball/swirl_3.png"),
            IronsSpellbooks.id("textures/entity/waterball/swirl_4.png"),
            IronsSpellbooks.id("textures/entity/waterball/swirl_5.png"),
            IronsSpellbooks.id("textures/entity/waterball/swirl_6.png"),
            IronsSpellbooks.id("textures/entity/waterball/swirl_7.png"),
            IronsSpellbooks.id("textures/entity/waterball/swirl_8.png"),
            IronsSpellbooks.id("textures/entity/waterball/swirl_9.png"),
            IronsSpellbooks.id("textures/entity/waterball/swirl_10.png")
    };

    private final ModelPart orb;
    private final ModelPart swirl;

    public H20Renderer(Context context) {
        super(context);
