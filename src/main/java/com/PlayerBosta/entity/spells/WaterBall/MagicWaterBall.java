...
public class MagicWaterBall extends AbstractMagicProjectile implements ItemSupplier {
    public MagicWaterBall(EntityType<? extends Projectile> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    public MagicWaterBall(Level pLevel, LivingEntity pShooter) {
        this(EntityRegistro.WATER_BALL.get(), pLevel);
