...
public class WaterballRenderer extends EntityRenderer<Projectile> {

    public static final ModelLayerLocation MODEL_LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(MoreSpells.MODID, "fireball_model"), "main");
    private static final ResourceLocation BASE_TEXTURE = MoreSpells.id("textures/entity/waterball/magma.png");
    private static final ResourceLocation[] FIRE_TEXTURES = {
            MoreSpells.id("textures/entity/waterball/fire_0.png"),
            MoreSpells.id("textures/entity/waterball/fire_1.png"),
            MoreSpells.id("textures/entity/waterball/fire_2.png"),
            MoreSpells.id("textures/entity/waterball/fire_3.png"),
            MoreSpells.id("textures/entity/waterball/fire_4.png"),
            MoreSpells.id("textures/entity/waterball/fire_5.png"),
            MoreSpells.id("textures/entity/waterball/fire_6.png"),
            MoreSpells.id("textures/entity/waterball/fire_7.png")
    };
    ...
    public WaterballRenderer(Context context, float scale) {
        super(context);
