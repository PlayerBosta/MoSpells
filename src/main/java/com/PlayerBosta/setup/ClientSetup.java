...
import com.PlayerBosta.entity.spells.WaterBall.WaterballRenderer;
...
@Mod.EventBusSubscriber(modid = MoreSpells.MODID, bus = Mod.EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
...
//        event.registerLayerDefinition(NecromancerRenderer.NECROMANCER_OUTER_ARMOR, () -> outerLayer);
        ...
        event.registerLayerDefinition(WaterballRenderer.MODEL_LAYER_LOCATION, WaterballRenderer::createBodyLayer);
